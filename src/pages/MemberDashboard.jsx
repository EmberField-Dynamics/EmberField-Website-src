...
export default function MemberDashboard() {
  ...
  const { user, loading, updateProfile, linkGoogle, logout } = useAuth()
          ...
          <div style={{ display: 'flex', alignItems: 'center', justifyContent: 'space-between', padding: '16px', borderRadius: '12px', border: '1px solid var(--border)', background: 'var(--input-bg)', marginBottom: '12px' }}>
            <div style={{ display: 'flex', alignItems: 'center', gap: '12px' }}>
              ...
              <div>
                ...
                <div style={{ fontSize: '12px', color: 'var(--text-secondary)' }}>Connected</div>
              </div>
            </div>
            <span style={{ fontSize: '12px', color: '#10B981', fontWeight: 700 }}>Linked</span>
          </div>
